...
module spm (clk,
 ...
 sky130_ef_sc_hd__decap_12 FILLER_0_10_148 ();
 ...
 sky130_fd_sc_hd__decap_3 FILLER_0_10_39 ();
 ...
 sky130_ef_sc_hd__decap_12 FILLER_0_18_50 ();
 ...
 sky130_fd_sc_hd__decap_6 FILLER_0_19_76 ();
 ...
 sky130_fd_sc_hd__decap_4 FILLER_0_24_158 ();
 ...
 sky130_fd_sc_hd__decap_4 FILLER_0_27_34 ();
 ...
 sky130_fd_sc_hd__decap_4 FILLER_0_29_139 ();
 ...
 sky130_fd_sc_hd__decap_6 FILLER_0_5_176 ();
 ...
 sky130_fd_sc_hd__clkbuf_4 _229_ (.A(net34),
    .X(_000_));
 ...
 sky130_fd_sc_hd__dfrtp_1 _279_ (.CLK(clknet_3_7__leaf_clk),
    ...
    .RESET_B(net33),
    .Q(\dsa[5].y_out ));
 sky130_fd_sc_hd__dfrtp_1 _280_ (.CLK(clknet_3_6__leaf_clk),
 ...
 sky130_fd_sc_hd__dfrtp_1 _284_ (.CLK(clknet_3_6__leaf_clk),
    ...
    .RESET_B(net33),
    .Q(\dsa[8].last_carry ));
 sky130_fd_sc_hd__dfrtp_1 _285_ (.CLK(clknet_3_3__leaf_clk),
    .D(\dsa[8].y_out_next ),
    .RESET_B(net33),
    .Q(\dsa[8].y_out ));
 ...
 sky130_fd_sc_hd__dfrtp_1 _296_ (.CLK(clknet_3_6__leaf_clk),
    ...
    .RESET_B(net33),
    .Q(\dsa[14].last_carry ));
 sky130_fd_sc_hd__dfrtp_1 _297_ (.CLK(clknet_3_5__leaf_clk),
    .D(\dsa[14].y_out_next ),
    .RESET_B(net33),
    .Q(\dsa[14].y_out ));
 ...
 sky130_fd_sc_hd__dfrtp_1 _300_ (.CLK(clknet_3_4__leaf_clk),
    ...
    .RESET_B(net33),
    .Q(\dsa[16].last_carry ));
 sky130_fd_sc_hd__dfrtp_1 _301_ (.CLK(clknet_3_4__leaf_clk),
    .D(\dsa[16].y_out_next ),
    .RESET_B(net33),
    .Q(\dsa[16].y_out ));
 ...
 sky130_fd_sc_hd__dfrtp_1 _310_ (.CLK(clknet_3_1__leaf_clk),
    ...
    .RESET_B(net33),
    .Q(\dsa[21].last_carry ));
 sky130_fd_sc_hd__dfrtp_1 _311_ (.CLK(clknet_3_0__leaf_clk),
    .D(\dsa[21].y_out_next ),
    .RESET_B(net33),
    .Q(\dsa[21].y_out ));
 ...
 sky130_fd_sc_hd__dfrtp_1 _326_ (.CLK(clknet_3_0__leaf_clk),
    ...
    .RESET_B(net33),
    .Q(\dsa[29].last_carry ));
 sky130_fd_sc_hd__dfrtp_1 _327_ (.CLK(clknet_3_1__leaf_clk),
    .D(\dsa[29].y_out_next ),
    .RESET_B(net33),
    .Q(\dsa[29].y_out ));
